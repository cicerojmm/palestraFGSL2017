...
const char* ssid = "fgls,iot";          // troque pelo nome da sua rede
const char* password = "fgsl2017";     // troque pela senha da sua rede
WiFiClient nodemcuClient;

// --- MQTT ---
#include <PubSubClient.h>
const char* mqtt_Broker = "iot.eclipse.org";
const char* mqtt_ClientID = "termometro-fgls2017";
PubSubClient client(nodemcuClient);
const char* topicoTemperatura = "fgsl/temperatura";
const char* topicoUmidade = "fgsl/umidade";
